...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_ALARM_HOUR ="Alarm_H";
    private static final String COLUMN_ALARM_MINUTE ="Alarm_Min";
    private static final String COLUMN_ALARM_STATUS ="Alarm_Stat";
